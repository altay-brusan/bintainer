using Bintainer.Modules.Inventory.Application.Components.UpdateComponent;
using FluentValidation.TestHelper;

namespace Bintainer.Modules.Inventory.Application.UnitTests.Components.UpdateComponent;
