...
using Bintainer.Modules.Inventory.Application.Categories.DeleteCategory;
using Bintainer.Modules.Inventory.Domain.Categories;

namespace Bintainer.Modules.Inventory.Application.UnitTests.Categories.DeleteCategory;
